...
var drawChart = function(el, data) {
	...
	var mainSequence = chartArea.append('path')
				.datum(data)
				.attr('class','main-seq-line')
				.attr('d', mainSeqline);
	...
	function redrawChart() {
		...
		mainChart.selectAll('path.main-seq-line').attr('d', mainSeqline);
	}
